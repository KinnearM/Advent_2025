...
I just want make sure I have a really good handle of the basics of Python and its limitations so that I may truly understand the need for more advanced tools. 
My plan is to remove the "no imports" restriction for next year's Advent of Code but this is my first year so it's possible that the later problems are unsolvable wihout imports.
